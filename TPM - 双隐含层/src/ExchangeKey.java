...
public class ExchangeKey {
    ...
    public String generateKey_Server() throws Exception {
        String msg1 = socketConnection.listen(n+","+k+","+k1+","+bound+'\0',msg -> {
        ...
        k1 = Integer.parseInt(param[2]);
        bound = Integer.parseInt(param[3]);
...
//        }
        ...
        while (true) {
            ...
            //socketConnection = new SocketConnection(port,host);
            //System.out.println("发送的数据："+out1+","+short2string(tpm.getSecretKey())+'\0');
            msg1 = socketConnection.listen(out1+","+short2string(tpm.getSecretKey())+'\0',msg -> {
...
//            }
    ...
    public String generateKey_Client() throws IOException {
        String msg1 = socketConnection.send(n+","+k+","+k1+","+bound,msg -> {
            System.out.println("协商后的参数: "+msg);
        });
